...
int16 LTE_fdd_dl_scan_interface::get_ppm_corr(void)
{
    return(ppm_corr);
}
uint32 LTE_fdd_dl_scan_interface::get_gain(void)
{
    return(gain);
}
...
void LTE_fdd_dl_scan_interface::read_ppm_corr(void)
{
    send_ctrl_status_msg(LTE_FDD_DL_SCAN_STATUS_OK, boost::lexical_cast<std::string>(ppm_corr));
}
void LTE_fdd_dl_scan_interface::write_ppm_corr(std::string ppm_corr_str)
{
    ppm_corr = boost::lexical_cast<int16>(ppm_corr_str);
    send_ctrl_status_msg(LTE_FDD_DL_SCAN_STATUS_OK, "");
}
void LTE_fdd_dl_scan_interface::read_gain(void)
{
    send_ctrl_status_msg(LTE_FDD_DL_SCAN_STATUS_OK, boost::lexical_cast<std::string>(gain));
}
void LTE_fdd_dl_scan_interface::write_gain(std::string gain_str)
{
	...
	gain = 0;
    	send_ctrl_status_msg(LTE_FDD_DL_SCAN_STATUS_FAIL, "Invalid gain value");
    }
}
