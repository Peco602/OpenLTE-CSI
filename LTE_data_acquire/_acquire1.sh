...
#cd ./HACKRF_DATA
#../captureRawData_HACKRF.sh -T 2 -f "806e6 1870e6" -s 15360000 -b 10000000 -n 307200000 -F $1
#cd ..

cd ./RTL_DATA
../captureRawData_HACKRF.sh -T 2 -f "796e6 806e6 816e6 1870e6" -s 1920000 -b 2500000 -n 38400000 -F $1
cd ..
