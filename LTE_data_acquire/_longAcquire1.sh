...
spd-say -w "Move to position 1";sleep 10;
spd-say -w "Starting measurement";
./_acquire.sh r1;
sleep 2;
spd-say -w "Testing"; 
./_acquire.sh t1
...
spd-say -w "Move to position 2";sleep 10;
spd-say -w "Starting measurement";
./_acquire.sh r2;
sleep 2;
spd-say -w "Testing";
...
spd-say -w "Move to position 3";sleep 10;
spd-say -w "Starting measurement";
./_acquire.sh r3;
sleep 2;
spd-say -w "Testing";
...
spd-say -w "Move to position 4";sleep 10;
spd-say -w "Starting measurement";
./_acquire.sh r4;
sleep 2;
spd-say -w "Testing";
...
spd-say -w "Leave the room";sleep 30;
spd-say -w "Starting measurement";
./_acquire.sh r0;
sleep 5;
spd-say -w "Testing";
...
##################################
spd-say -w "Move the chair to change environment";sleep 45;
